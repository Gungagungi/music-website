...
Seven decisions that shaped the framework, recorded with the alternatives that were rejected and
...
| [007](007-preproduction.md) | One pre-production slot on the production host | A build competes with the store for CPU; one branch at a time |
